...
public class ListaEstudiantes {
    ...
    private int n;
    public ListaEstudiantes() {//soporta hasta 10000 estudiantes
    ...
    public void ordenar() {
        Arrays.sort(estudiantes, 0, n,(e1, e2) -> e1.getNombre().compareTo(e2.getNombre()));
    }
    ...
    public void mostrarMenu() {
        ...
        System.out.println("Comando 1: Agregar estudiante y nota: 1&nombre_estudiante & nota");
        System.out.println("Comando 2: Calcular promedio de los estudiantes en un momento dado.");
    ...
    public void procesarComandos() {
        ...
        do {
            ...
            switch (comando[0]) {
                case "1":agregarEstudiante(new Estudiante(comando[1],Double.parseDouble(comando[2])));break;
                case "2":promedio();break;
                case "3":ordenar();break;
                case "4":consultar(comando[1]);break;
