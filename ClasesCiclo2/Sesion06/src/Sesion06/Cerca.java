/*Un campesino de la región le pide crear un programa de computador que le permita determinar cual de dos opciones
(madera o alambre) es la mejor opción (menor costo) para encerrar un terreno rectangular de n ∗ m metros cuadrados, sabiendo el
costo de un metro lineal de alambre, el costo de un metro de madera y la cantdad de hilos de alambre o hileras de madera. El
